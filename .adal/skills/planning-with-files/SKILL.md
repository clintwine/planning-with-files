...
hooks:
  ...
  Stop:
    - hooks:
        - type: command
          command: |
            SCRIPT_DIR="${ADAL_SKILL_ROOT:-$HOME/.adal/skills/planning-with-files}/scripts"
...
$(command -v python3 || command -v python) ${ADAL_SKILL_ROOT}/scripts/session-catchup.py "$(pwd)"
```

```powershell
# Windows PowerShell
python "$env:USERPROFILE\.adal\skills\planning-with-files\scripts\session-catchup.py" (Get-Location)
```
...
- **Templates** are in `${ADAL_SKILL_ROOT}/templates/`
- **Your planning files** go in **your project directory**

| Location | What Goes There |
|----------|-----------------|
| Skill directory (`${ADAL_SKILL_ROOT}/`) | Templates, scripts, reference docs |
